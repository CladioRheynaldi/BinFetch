...
var AuthService = function () {
    ...
    var AuthService = _classThis =  (function () {
        ...
        AuthService_1.prototype.register = function (email, pass, fullName) {
            return __awaiter(this, void 0, void 0, function () {
                var supabase, saltRounds, hashedPassword, _a, data, error;
        ...
        AuthService_1.prototype.login = function (email, pass) {
            return __awaiter(this, void 0, void 0, function () {
                var supabase, _a, user, error, isMatch;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            supabase = this.supabaseService.getClient();
